...
'''_______________________                           INDEXING      __________________________________________________'''
...
#--------------------------------------------------------
'''12.WAP by take user input , convert first and Last alphabet in capital letter
       and rest in small letter'''
x=input("enter name:")
y=x[0].upper()
z=x[-1].upper()
